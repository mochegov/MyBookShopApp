    ...
    $(function () {
                ...
                init: function () {
                    ...
                    $('.form_search').on('submit', function (e) {
                        ...
                        if (pageSearch) {
                            ...
                            // Кнопка "Поиск" на странице поиска
        ...
        var Card = function () {
            var bookTemplate = function (book) {
                return '<div class="Card">' + ' <div class="Card-picture">' + '<a href="/books/' + book.id + '">' + ' <img src="' + book.image + '">\n' + '</a>' +
                    ...
                    ' <div class="Card-content">\n' + ' <strong class="Card-title"><a href="#">' + book.title + ' [*' + book.pubDate + '*] ' + '</a>\n' + ' </strong>\n' +
                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                            ...
                            case'popular':
                                ...
                                break;
                            case'genre':
                                getData('/books/nextgenre/' + $this.data('refreshid'), {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if (oldOffset < 1){
                                            $this.data('refreshoffset', ++oldOffset);
                                ...
                                break;
                            case'author':
                                getData('/books/nextauthor/' + $this.data('refreshid'), {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if (oldOffset < 1){
                                            $this.data('refreshoffset', ++oldOffset);
                                ...
                                break;
                            case'tag':
                                getData('/books/nexttag/' + $this.data('refreshid'), {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if (oldOffset < 1){
                                            $this.data('refreshoffset', ++oldOffset);
                                ...
                                break;
                            case'search':
                                // Кнопка "Показать ещё" на странице поиска
        ...
        var Login = function () {
            ...
            function postData(address, data, cb, cbErr) {
                //alert('Вызов postData address: ' + address + 'data: ' + JSON.stringify(data, null, 4));
                ...
                $.ajax({
                    ...
                    data: data,
                    complete: function (result) {
                        //alert('complete postData, result: ' + JSON.stringify(result, null, 4));
                                    ...
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        switch ($(slick.$slider).data('load')) {
                                            case'recommended':
                                                ...
                                                break;
                                            case'recent':
                                                sendData('/books/nextrecent')
                                                break;
                                            case'popular':
                                                sendData('/books/nextpopular')
                                                break;
                                        }
                                    }
                                }
